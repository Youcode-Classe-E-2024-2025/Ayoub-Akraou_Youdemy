...
<div class="min-h-screen bg-gray-100 pt-24 pb-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div class="bg-white rounded-lg shadow-lg p-6 md:p-8">
            ...
            <form action="/courses/add" method="POST" class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" required
                            ...
                            class="mt-1 block w-full rounded-md px-3 py-1.5 border border-gray-400 shadow-sm focus:border-violet-500 focus:ring-violet-500"></textarea>
                    </div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php foreach ($tags as $tag): ?>
                                <label class="cursor-pointer">
                                    ...
                                    <span class="border-2 px-3 py-1.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-full 
                                               hover:bg-gray-200 inline-block transition-all duration-200">
